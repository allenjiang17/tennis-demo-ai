...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: 'amateur-backhand-1', player: 'Amateur', shot: 'backhand', stats: { power: 45, spin: 35, control: 50, shape: 35 }, price: 20, tier: 'amateur' },
  { id: 'amateur-backhand-2', player: 'Amateur', shot: 'backhand', stats: { power: 50, spin: 40, control: 45, shape: 40 }, price: 40, tier: 'amateur' },
